        ...
        <div class="right-sidebar-group">
            ...
            <div>
                <div class="sidebar-bg-btn-box">
                    ...
                    <button class="sidebar-bg-btn" data-img="/assets/back/images/nav-bg-1.jpg"></button>
                    <button class="sidebar-bg-btn" data-img="/assets/back/images/nav-bg-2.jpg"></button>
                    <button class="sidebar-bg-btn" data-img="/assets/back/images/nav-bg-3.jpg"></button>
                    <button class="sidebar-bg-btn" data-img="/assets/back/images/nav-bg-4.jpg"></button>
                </div>
            </div>
        </div>
        <div class="right-sidebar-group">
            ...
            <div>
                <div class="main-content-bg-btn-box">
                    ...
                    <button class="main-content-bg-btn" data-img="/assets/back/images/main-bg-1.jpg"></button>
                    <button class="main-content-bg-btn" data-img="/assets/back/images/main-bg-2.jpg"></button>
                    <button class="main-content-bg-btn" data-img="/assets/back/images/main-bg-3.jpg"></button>
                    <button class="main-content-bg-btn" data-img="/assets/back/images/main-bg-4.jpg"></button>
                </div>
            </div>
        </div>
        <div class="right-sidebar-group">
